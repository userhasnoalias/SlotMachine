...
void StateIdle::onCreate()
{
	...
	m_button_text.setString(m_button.label);
	m_button_text.setCharacterSize(m_button.character_size);
	m_button_text.setFillColor(m_button.label_color);
	...
	m_button_shape.setSize(m_button.size);
...
void StateIdle::draw()
{
	...
	m_button_shape.setPosition(m_button.button_position);
